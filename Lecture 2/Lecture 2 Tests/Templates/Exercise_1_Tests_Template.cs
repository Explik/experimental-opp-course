...
namespace Lecture_2_Tests
{
    ...
    public class Exercise_1_Tests_Template
    {
        ...
        {
            // This code contains extensions to the regular MSTest
            Person person = new Person()
            {
                FirstName = "Adam",
                LastName = "Smith",
